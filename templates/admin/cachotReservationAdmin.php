<h1>cachotReservation()</h1>
<p>shortcode: <code>[cachot_reservation]</code></p>
...
<div class="row row-no-gutters containerContent">
    <div class="col-md-12 col-sm-12 col-xs-12" style="text-align: center;">
        ...
        <h2>Cachot - <?= $calendars->monthsen2fr($month) . ' ' . $year ?></h2>
        <h4>
            <a href="admin.php?page=apocalypstar_cachot&amp;week=pre&amp;jour=<?= $jour ?>"><img src="<?= plugin_dir_url(dirname(__FILE__, 2)) . 'assets/img/arrow2.png' ?>"height="30px"></a>
                Jour du: <?= $dateCurrent . ' au ' . $dateEnd ?>
            <a href="admin.php?page=apocalypstar_cachot&amp;week=next&amp;jour=<?= $jour ?>"><img src="<?= plugin_dir_url(dirname(__FILE__, 2)) . 'assets/img/arrow.png' ?>"  height="30px"></a>
        </h4>
    </div>
 ...
 */ ?>
            ...
            <input id="room" type="hidden" name="room" value="3">
